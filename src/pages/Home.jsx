...
const Home = () => {
  ...
  const fetchingBooks = async (query = "") => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:1000/books?${query}`, {
  ...
  const deleteBook = async (idBook) => {
    ...
    if (!confirm("Esta seguro de que quieres borrar el libro?")) {
      ...
      <section >
        ...
        <form className="filters-form" onSubmit={handleSubmit}>
          ...
          <input type="text"
            ...
            name="author" placeholder="Buscar por autor"

            onChange={handleChange} value={filters.author}
...

            {
              ...
              GENRE.map((genre) =>
                ...
                <option key={genre.id}
                  ...
                  value={genre.value}>{genre.content}
